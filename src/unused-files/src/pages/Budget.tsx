              ...
              <BlurredCard className="lg:col-span-2 animate-scale-in" style={{ animationDelay: "300ms" }}>
                ...
                <div className="space-y-6">
                  {budgetCategories.map((category, index) => {
                    ...
                    // Create a class for the indicator color
                    const indicatorColor = percentSpent > 90 ? "bg-red-500" :
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Use a wrapper div to apply custom styling to the Progress component */}
